...
prefs = {
    ...
    "media_stream_mic": {"D:\\Assistants\\J.A.R.V.I.S\\Clap_Detection\\clap-detection.html": 1}  # Ensure permissions for your site
}
...
driver.get("D:\\Assistants\\J.A.R.V.I.S\\Clap_Detection\\clap-detection.html")
...
while True:
    try:
        ...
        if current_output == "Clap detected!":
            with open("D:\\Assistants\\J.A.R.V.I.S\\input.txt","w") as file:
                file.write("Activate!")
